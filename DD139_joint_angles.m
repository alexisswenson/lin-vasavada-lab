...
DD139_nan = readtable("DD139_slope_all trials_merged.csv");
%DD139_nan = readtable("DD133_tread_slopes_merged.csv");
%DD139_nan = readtable("DD133_slopes_merged.csv");
...
% %table to array
% A_hip_array = table2array(A_hip);
% A_knee_array = table2array(A_knee);
% A_ankle_array = table2array(A_ankle);
...
%add landing column to alexis_angles_with_time
...
mean_values=array2table(mean_values_array, 'VariableNames', {'Hip_Angle', 'Knee_Angle', 'Ankle_Angle', 'Time'});
