...
% data_nan = readtable("files for MATLAB/merged/DD_old/DD139_slope_all trials_merged(old).csv");
% data_nan = readtable("files for MATLAB/merged/DD_old/DD133_tread_slopes_merged.csv");
% data_nan = readtable("files for MATLAB/merged/DD_old/DD133_slopes_merged.csv");

% data_nan = readtable("files for MATLAB/merged/DD_old/DD130_slopes_01_merged.csv");
% data_nan = readtable("files for MATLAB/merged/DD_old/DD130_slopes_02_merged.csv");
% data_nan = readtable("files for MATLAB/merged/DD_old/DD135_slopes_02_merged.csv");

% data_nan = readtable("files for MATLAB/merged/SCD/SCDD03_hard.csv");
% data_nan = readtable("files for MATLAB/merged/SCD/SCDD03_sand.csv");
% data_nan = readtable("files for MATLAB/merged/SCD/SCDD10_sand.csv");
% data_nan = readtable("files for MATLAB/merged/SCD/SCDD10_sand2.csv");

% data_nan = readtable("files for MATLAB/merged/DD119/DD119_event05.csv");
...
if ismember('Wedge', angles_table.Properties.VariableNames)
    filtered_angles_table = angles_table(angles_table.steadyhopping == 1 & angles_table.wedge_back == 0 & angles_table.wedge_front == 0 & angles_table.wedge == 0, :);
else
    filtered_angles_table = angles_table(angles_table.steadyhopping == 1 & angles_table.wedge_back == 0 & angles_table.wedge_front == 0, :);
end
