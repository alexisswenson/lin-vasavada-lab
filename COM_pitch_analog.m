...
% These are pathways to sand and solid merged files for 118B, 118A, 119,and 121. 
% To switch between files, just uncomment the ones you want to
% analyze and comment (%) the ones you don't. 

% Sand
% data_sand = readtable('D:\DD118B\merged\merged_DD118B_sand4000!.csv');
% data_sand = readtable('D:\DD118A\merged\merged_DD118A_sand4000!.csv');
 data_sand = readtable('D:\DD119\merged\merged_DD119_sand!.csv');
% data_sand = readtable('D:\DD121\merged\merged_DD121_sand4000!.csv');

% Solid
% data_solid = readtable('D:\DD118B\merged\merged_DD118B_solid4000!.csv');
% data_solid = readtable('D:\DD118A\merged\merged_DD118A_solid4000!.csv');
% data_solid = readtable('D:\DD119\merged\merged_DD119_solid4000!.csv');
 data_solid = readtable('D:\DD121\merged\merged_DD121_solid.csv');
...
filtEMG1_sand = table(data_sand.filtered_EMG_1,'VariableNames', {'filtEMG1'});
filtEMG2_sand = table(data_sand.filtered_EMG_2,'VariableNames', {'filtEMG2'});
filtbuckle_sand = table(data_sand.filtered_Buckle,'VariableNames', {'filtBuckle'});
filtsono_sand = table(data_sand.filtered_SONO,'VariableNames', {'filtSono'});
...
filtEMG1_solid = table(data_solid.filtered_EMG_1,'VariableNames', {'filtEMG1'});
filtEMG2_solid = table(data_solid.filtered_EMG_2,'VariableNames', {'filtEMG2'});
filtbuckle_solid = table(data_solid.filtered_Buckle,'VariableNames', {'filtBuckle'});
filtsono_solid = table(data_solid.filtered_SONO,'VariableNames', {'filtSono'});

% Add the 'Landing' and 'SteadyHopping' columns to com_table
com_table_sand = [com_table_sand, landing_column_sand, steadyhopping_column_sand,filtEMG1_sand, filtEMG2_sand, filtbuckle_sand, filtsono_sand];
com_table_solid = [com_table_solid, landing_column_solid, steadyhopping_column_solid, filtEMG1_solid, filtEMG2_solid, filtbuckle_solid, filtsono_solid];
...
filtEMG1_name_sand = 'filtEMG1';
filtEMG2_name_sand = 'filtEMG2';
filtBuckle_name_sand = 'filtBuckle';
filtSono_name_sand = 'filtSono';

time_column_name_solid = 'time';
com_y_column_name_solid = 'com_y';
pitch_angle_column_name_solid = 'pitch_angle';
filtEMG1_name_solid = 'filtEMG1';
filtEMG2_name_solid = 'filtEMG2';
filtBuckle_name_solid = 'filtBuckle';
filtSono_name_solid = 'filtSono';

% Group the column names in a cell array
column_names_sand = {time_column_name_sand, com_y_column_name_sand, pitch_angle_column_name_sand, filtEMG1_name_sand, filtEMG2_name_sand, filtBuckle_name_sand, filtSono_name_sand };
column_names_solid = {time_column_name_solid, com_y_column_name_solid, pitch_angle_column_name_solid, filtEMG1_name_solid, filtEMG2_name_solid, filtBuckle_name_solid, filtSono_name_solid};
...
for i = 1:numel(cycles_array_solid)
    ...
    current_double(:, 8) = derivative_column;
...
for i = 1:numel(cycles_array_solid)
    ...
    angular_momentum_column = current_double(:, 8);
    ...
    current_double(:, 8) = filtered_angular_momentum;
...
for i = 1:numel(cycles_array_sand)
    ...
    % Append the filtered angular momentum as a new column to current_double
    current_double = [current_double, filtered_angular_momentum];
...
column_names_sand = {'time', 'com', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'};
column_names_solid = {'time', 'com', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'};
...
num_columns = 8; % Assuming you have 4 columns of interest (excluding the time column)
...
mean_values_sand = array2table(mean_values_array_sand, 'VariableNames', {'Time', 'COM', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'});
...
mean_values_solid = array2table(mean_values_array_solid, 'VariableNames', {'Time', 'COM', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'});
...
figure(4)
errorbar(mean_values_solid.Time, mean_values_solid.pitch_angle, std_values_solid.pitch_angle, '-o', 'MarkerFaceColor', 'r', 'MarkerSize', 5);
hold on;
errorbar(mean_values_solid.Time, mean_values_solid.pitch_angle, -std_values_solid.pitch_angle, 'o', 'MarkerFaceColor', 'b', 'MarkerSize', 5);
hold off;
xlabel("HOP CYCLE PERCENT")
ylabel("Pitch Angle [deg]")
legend('Mean', 'Std Dev')
...
for i = 1:num_hop_cycles_sand
    % Skip cycle 29, 209
    if i == 14 || i == 17 || i == 19 || i == 23 || i == 26 || i == 29 || i == 40 || i == 62
        continue;
    end
...
figure(8)
errorbar(mean_values_sand.Time, mean_values_sand.pitch_angle, std_values_sand.pitch_angle, '-o', 'MarkerFaceColor', 'r', 'MarkerSize', 5);
hold on;
errorbar(mean_values_sand.Time, mean_values_sand.pitch_angle, -std_values_sand.pitch_angle, 'o', 'MarkerFaceColor', 'b', 'MarkerSize', 5);
hold off;
xlabel("HOP CYCLE PERCENT")
ylabel("Pitch Angle [deg]")
legend('Mean', 'Std Dev')
...
for i = 1:num_hop_cycles_sand
 % Skip cycle 29, 209
    ...
    current_array = cycles_array_sand{i};
    current_table_wrong_names=array2table(current_array);
    current_table = renamevars(current_table_wrong_names, {'current_array1','current_array2','current_array3', 'current_array4', 'current_array5','current_array6','current_array7', 'current_array8'}, {'time', 'com', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'});
    x_values = current_table.time;
...
for i = 1:num_hop_cycles_sand
    ...
    current_table = renamevars(current_table_wrong_names, {'current_array1','current_array2','current_array3', 'current_array4', 'current_array5','current_array6','current_array7', 'current_array8'}, {'time', 'com', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'});
    x_values = current_table.time;
    y_values = current_table.filtEMG1;
    plot(x_values, y_values);
    xlabel("HOP CYCLE PERCENT")
    ylabel("EMG 1 [Volts]")
    title('EMG 1 on a Sand Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
for i = 1:num_hop_cycles_sand
    ...
    current_table = renamevars(current_table_wrong_names, {'current_array1','current_array2','current_array3', 'current_array4', 'current_array5','current_array6','current_array7', 'current_array8'}, {'time', 'com', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'});
    x_values = current_table.time;
    y_values = current_table.filtBuckle;
    plot(x_values, y_values);
    xlabel("HOP CYCLE PERCENT")
    ylabel("Buckle [Volts]")
    title('Buckle on a Sand Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
for i = 1:num_hop_cycles_sand
    ...
    current_table = renamevars(current_table_wrong_names, {'current_array1','current_array2','current_array3', 'current_array4', 'current_array5','current_array6','current_array7', 'current_array8'}, {'time', 'com', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'});
    x_values = current_table.time;
    y_values = current_table.filtSono;
    plot(x_values, y_values);
    xlabel("HOP CYCLE PERCENT")
    ylabel("Sono [Volts]]")
    title('Sono on a Sand Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
for i = 1:num_hop_cycles_solid
    ...
    xlabel("HOP CYCLE PERCENT")
    ylabel("EMG1 [Volts]")
    title('EMG1 on a Solid Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
for i = 1:num_hop_cycles_solid
    ...
    xlabel("HOP CYCLE PERCENT")
    ylabel("Buckle [Volts]]")
    title('Buckle on a Solid Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
for i = 1:num_hop_cycles_solid
    ...
    xlabel("HOP CYCLE PERCENT")
    ylabel("Sono [Volts]")
    title('Sono on a Solid Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
for i = 1:num_hop_cycles_solid
    ...
    current_table = renamevars(current_table_wrong_names, {'current_array1','current_array2','current_array3', 'current_array4', 'current_array5','current_array6','current_array7', 'current_array8'}, {'time', 'com', 'pitch_angle', 'filtEMG1', 'filtEMG2', 'filtBuckle', 'filtSono', 'angular_momentum'});
    x_values = current_table.time;
    y_values = current_table.filtEMG2;
    plot(x_values, y_values);
    xlabel("HOP CYCLE PERCENT")
    ylabel("EMG 2 [Volts]")
    title('EMG 2 on a Solid Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
for i = 1:num_hop_cycles_sand
    ...
    xlabel("HOP CYCLE PERCENT")
    ylabel("EMG 2 [Volts]")
    title('EMG 2 on a Sand Surface vs Hop Cycle Percent')
    hold on;
% Create a separate line plot for each cycle
    line_handle = plot(x_values, y_values, 'DisplayName', ['Cycle ' num2str(i)]);
end
...
% figure(21)
% errorbar(mean_values_sand.Time, mean_values_sand.filtEMG1, std_values_sand.filtEMG1, '-o', 'MarkerFaceColor', 'r', 'MarkerSize', 5);
% hold on;
% errorbar(mean_values_sand.Time, mean_values_sand.filtEMG1, -std_values_sand.filtEMG1, 'o', 'MarkerFaceColor', 'b', 'MarkerSize', 5);
% hold off;
% xlabel("HOP CYCLE PERCENT")
% ylabel("EMG 1 [Volts]")
% legend('Mean', 'Std Dev')
% title('Average EMG 1 on a Sand Surface vs Hop Cycle Percent')
% 
% figure(22)
% errorbar(mean_values_sand.Time, mean_values_sand.filtEMG2, std_values_sand.filtEMG2, '-o', 'MarkerFaceColor', 'r', 'MarkerSize', 5);
% hold on;
% errorbar(mean_values_sand.Time, mean_values_sand.filtEMG2, -std_values_sand.filtEMG2, 'o', 'MarkerFaceColor', 'b', 'MarkerSize', 5);
% hold off;
% xlabel("HOP CYCLE PERCENT")
% ylabel("EMG 1 [Volts]")
% legend('Mean', 'Std Dev')
% title('Average EMG 2 on a Sand Surface vs Hop Cycle Percent')
% 
% figure(23)
% errorbar(mean_values_solid.Time, mean_values_solid.filtEMG1, std_values_solid.filtEMG1, '-o', 'MarkerFaceColor', 'r', 'MarkerSize', 5);
% hold on;
% errorbar(mean_values_solid.Time, mean_values_solid.filtEMG1, -std_values_solid.filtEMG1, 'o', 'MarkerFaceColor', 'b', 'MarkerSize', 5);
% hold off;
% xlabel("HOP CYCLE PERCENT")
% ylabel("EMG 1 [Volts]")
% legend('Mean', 'Std Dev')
% title('Average EMG 1 on a Solid Surface vs Hop Cycle Percent')
% 
% figure(24)
% errorbar(mean_values_solid.Time, mean_values_solid.filtEMG2, std_values_solid.filtEMG2, '-o', 'MarkerFaceColor', 'r', 'MarkerSize', 5);
% hold on;
% errorbar(mean_values_solid.Time, mean_values_solid.filtEMG2, -std_values_solid.filtEMG2, 'o', 'MarkerFaceColor', 'b', 'MarkerSize', 5);
% hold off;
% xlabel("HOP CYCLE PERCENT")
% ylabel("EMG 1 [Volts]")
% legend('Mean', 'Std Dev')
% title('Average EMG 2 on a Solid Surface vs Hop Cycle Percent')
...
% figures = {figure(13), figure(16), figure(19), figure(20)};
% 
