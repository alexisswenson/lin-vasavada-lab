function [front_w_cycles] = front_wedge_cycles(data_nan)
...
filtered_angles_table = angles_table(angles_table.steadyhopping == 1 & (angles_table.wedge_front == 1 | angles_table.wedge == 1), :);
else
filtered_angles_table = angles_table(angles_table.steadyhopping == 1 & angles_table.wedge_front == 1, :);
end
...
front_w_cycles = cell(num_tables, 1);
...
for i = 1:num_tables
    ...
    front_w_cycles{i} = table(columns_data{:}, 'VariableNames', column_names);
end