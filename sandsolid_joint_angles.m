...
data_nan = readtable('D:\DD118B - invivo sand\merged\merged_DD118B_solid!.csv');
...
% add landing and steadyhopping column to angles
...
original_angle_names = {'angles1', 'angles2', 'angles3', 'angles4', 'angles5', 'angles6'};
new_angle_names = {'hip_angle', 'knee_angle', 'ankle_angle', 'foot_angle', 'landing', 'steadyhopping'};
...
filtered_angles_table = angles_table(angles_table.steadyhopping == 1, :);
