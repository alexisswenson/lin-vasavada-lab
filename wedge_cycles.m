function [w_cycles] = wedge_cycles(data_nan)
...
filtered_angles_table = angles_table(angles_table.steadyhopping == 1 & (angles_table.wedge_back == 1 | angles_table.wedge == 1) | angles_table.wedge_front == 1, :);
else
filtered_angles_table = angles_table(angles_table.steadyhopping == 1 & (angles_table.wedge_back == 1) | angles_table.wedge_front == 1, :);
end
...
for i = 1:num_tables
    ...
    w_cycles{i} = table(columns_data{:}, 'VariableNames', column_names);
end